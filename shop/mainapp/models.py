...
class LatestProductsManager:
    ...
    def get_products_for_main_page(*args, **kwargs):
        ...
        for ct_model in ct_models:
            model_products = ct_model.model_class()._base_manager.all().order_by('id')[0:5]
...
class Product(models.Model):
    ...
    # max_digits - how match numbers in price; decimal_places - how match numbers after comma
...
class Order(models.Model):
    ...
    order_date = models.DateField(verbose_name='Датаполучения заказа', default=timezone.now)
